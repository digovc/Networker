...
namespace Networker.Client
{
    public class Client : IClient
    {
        ...
        /// <inheritdoc />
        public void Send<T>(T packet) where T : PacketBase => Send(this.packetSerialiser.Serialise(packet));
        ...
        /// <inheritdoc />
        public void SendUdp<T>(T packet) where T : PacketBase => SendUdp(this.packetSerialiser.Serialise(packet));
